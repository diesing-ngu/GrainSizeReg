...
```{r aoi}
AoI <- read_sf(dsn = "input", layer = "AoI_Harris")
```
...
```{r load_response}
resp <- read_sf(dsn = "input", layer = "GrainSizeReg_4km_MaxCombArea_folk8_point_20230615")
...
writeRaster(rfprob, paste0("output/GrainSizeReg_folk8_probabilities_", Sys.Date(), ".tif"), names = model$levels)
